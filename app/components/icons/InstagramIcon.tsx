export default function InstagramIcon({ className }: { className: string }) {
  return (
    <>
      ...
      >
        <g clipPath="url(#clip0_2672_4645)">
          <path
            d="M14.166 1.66669H5.83268C3.5315 1.66669 1.66602 3.53217 1.66602 5.83335V14.1667C1.66602 16.4679 3.5315 18.3334 5.83268 18.3334H14.166C16.4672 18.3334 18.3327 16.4679 18.3327 14.1667V5.83335C18.3327 3.53217 16.4672 1.66669 14.166 1.66669Z"
            stroke="currentColor"
            strokeWidth="1.66667"
            strokeLinecap="round"
